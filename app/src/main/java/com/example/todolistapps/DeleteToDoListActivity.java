...
public class DeleteToDoListActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        ...
        Toast.makeText(DeleteToDoListActivity.this, "Martial Art is Deleted", Toast.LENGTH_SHORT).show();
        updateTheUserInterface();
    }
